...
Requires Node.js 22.13 or newer and Codex CLI 0.153.3 or newer. This release is validated against stable versions 0.153.3 and 0.153.4. Configuration priority is command options, `CODEX_BINARY` / `CODEX_HOME`, then system defaults.
